...
The figures below show example output created by these notebooks: mean
stream temperature on the Delaware River Basin (left) and time series of
shade and radiation terms for a single segment (right).

<div style="display: flex; gap: 2%; align-items: flex-start; margin-bottom: 1em">
  <img src="/pywatershed/assets/img/v3_0_0/stream_temp_drb_map.png"
       alt="Mean stream water temperature mapped on the Delaware River Basin stream network"
       style="width: 23%" />
  <img src="/pywatershed/assets/img/v3_0_0/stream_temp_segment_1447.png"
       alt="Time series of solar radiation, segment shade, and incoming shortwave for segment 1447"
       style="width: 73%" />
</div>
...
<div style="margin-bottom: 1em">
  <img src="/pywatershed/assets/img/v3_0_0/ag_water_use_fgr_map_zoom.png"
       alt="Difference of summed irrigation water added per HRU, shown in location and satellite map views"
       style="width: 100%" />
</div>

<div style="margin-bottom: 1em">
  <img src="/pywatershed/assets/img/v3_0_0/ag_water_use_fgr_irrigation_add_hru_86247.png"
       alt="Daily irrigation water added for HRU 86247, open-loop versus analysis"
       style="width: 100%" />
</div>

<div style="margin-bottom: 1em">
  <img src="/pywatershed/assets/img/v3_0_0/ag_water_use_hru_8611_precip_et_compare.png"
       alt="Evapotranspiration and precipitation time series for HRU 86113 comparing SSEBop, NHM, open-loop, and analysis"
       style="width: 100%" />
</div>
