...
These notes summarize the more detailed [What's New for version 3.0.0](https://pywatershed.readthedocs.io/en/latest/whats-new.html#v3-0-0-11-july-2026) in the documentation.
...
The new [`Output`](https://pywatershed.readthedocs.io/en/latest/api/generated/pywatershed.base.output.Output.html)
