...
from pywatershed.hydrology import PRMSRunoffAg
...
def control(simulation):
    ...
    if sim_name not in sim_names_to_test:
        pytest.skip(f"{sim_name} not tested by test_prms_runoff_ag.py")
    # <
...
def test_compare_prms(
    ...
    # }
    comparison_var_names = set(Runoff.get_variables()).intersection(
        set(control.options["netcdf_output_var_names"])
    )
